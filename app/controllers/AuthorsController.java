...
public class AuthorsController extends MyController {
    ...
    public static Promise<Result> getAuthorsRdf(@PathParam("authorname") String authorname) {
	...
	g.add(f.createStatement(subj,
		f.createURI("http://d-nb.info/standards/elementset/gnd#preferredNameForThePerson"), obj));
	g.add(f.createStatement(subj, f.createURI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
		f.createURI("http://d-nb.info/standards/elementset/gnd#UndifferentiatedPerson")));
