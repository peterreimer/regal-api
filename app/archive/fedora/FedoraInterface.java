...
public interface FedoraInterface {
	/**
	 * @param node the object as Fedora object
	 */
	 ...
	 * 
	 * @param pid The pid of an existing node.
	...
	/**
	 * 
	 * @param node the local java representation of the remote fedora object
	 */
	 ...
	 * 
	 * @param rootPID identifier of a fedora object
	 */
	public void deleteNode(String rootPID);

	/**
	 * @param pid the pid of the object
	 * @param datastream the datastream that must be deleted
	 */
	public void deleteDatastream(String pid, String datastream);

	/**
	 * @param namespace The namespace to generate a pid .
	 * @return A new generated id.
	 */
	public String getPid(String namespace);

	/**
	 * @param namespace The namespace of the pids
	 * @param number the number of pids
	 ...
	 * @param datastreamId of the objects datastream
	 * @return true if datastream exists
	 */
	public boolean dataStreamExists(String pid, String datastreamId);

	/**
	 * @param simpleQuery the query
	 * @param queryType if equals "simple" a simple search is done if equals "rdf"
	 *          it is the same like findTriples(rdfQuery, FedoraVocabulary.SPO,
	 *          FedoraVocabulary.N3);
	...
	/**
	 * @param rdfQuery A query
	 * @param queryType The type of the query
	 * @param outputFormat the format of the returned stream
	...
	/**
	 * Updates the list of ContentModel objects. If a ContentModel does't exist it
	 * will be created.
	 * 
	 * @param cms list of ContentModels
	 */
	public void updateContentModels(List<Transformer> cms);

	/**
	 * @param node dc stream will be added to this node
	 * @param in stream containing xml dc data
	 * @param dcNamespace namespace of the dc
	 */
	...
	/**
	 * @param node a node connected to a parent
	 ...
	 * to the node.
	 * 
	 * @param node all Parents will be removed
	 */
	 ...
	 * 
	 * @param node the node is a child of parent
	 * @param parentPid the pid of the parent
	 */
